...
use Symfony\Bundle\AsseticBundle\Component\Templating\TemplateReference as BaseTemplateReference;
...
class TemplateReference extends BaseTemplateReference
{
    ...
    {
        $name = sprintf('@%s:%s:%s.%s.%s', $this->parameters['bundle'], $this->parameters['controller'], $this->parameters['name'], $this->parameters['format'], $this->parameters['engine']);
